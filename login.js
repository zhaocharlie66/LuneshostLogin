const puppeteer = require("puppeteer-extra") const Stealth = require("puppeteer-extra-plugin-stealth")

const UA = require("./user_agents") const sendTG = require("./telegram") const {
    sleep,
    rand,
    humanType,
    randomMouse
...
const LOGIN_URL = "https://betadash.lunes.host/login?next=/"const HOME_URL = "https://betadash.lunes.host/"
